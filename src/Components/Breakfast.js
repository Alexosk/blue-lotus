  ...
  render() {
    return (
      <div className='content'>
        <h2 className='text-center mt-2 p-2'><b>Frukost</b></h2>
        <div className='d-flex justify-content-center'>
          <h6 className='font-weight-light'><span className='font-weight-bold'>Mån-Fre:</span> 8:30-12:00 <br /> <span className='font-weight-bold'>Lör-Sön:</span> 9:30-14:00</h6>
        </div>
        <div className='breakfast-parent mt-4 mb-4 px-5 d-flex flex-wrap text-center'>
          <div className='breakfast rounded mb-2'>
            ...
            <hr />
            <Badge className='pill' pill={true}>Vegan</Badge>
