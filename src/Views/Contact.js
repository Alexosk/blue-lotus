      ...
      <div className='mt-4 pt-5 content container'>
            ...
            <div className='d-flex flex-column justify-content-around flex-wrap' width='100%'>
              <ul className='p-4 text-center'>
                ...
                <li>
                  <h5 className='font-weight-light adress'><span className='font-weight-bold'>Adress:</span> Katarina&nbsp;Bangata&nbsp;21 <br/> 116 39 Stockholm</h5>
                </li>
                <li>
                  <h5 className='font-weight-light'><span className='font-weight-bold'>Tel:</span> +46 864 450 43</h5>
                </li>
              </ul>
              <ul className=' text-center p-4'>
                <h2 className='font-weight-bold'>Öppettider</h2>
                <li>
                  <h5 className='font-weight-light'><span className='font-weight-bold'>Mån-Tis:</span> 08:30 - 20:00</h5>
                </li>
                <li>
                  <h5 className='font-weight-light'><span className='font-weight-bold'>Ons-Fre:</span> 08:30 - 21:00</h5>
                </li>
                <li>
                  <h5 className='font-weight-light'><span className='font-weight-bold'>Lör:</span> 09:30 - 21:00</h5>
                </li>
                <li>
                  <h5 className='font-weight-light'><span className='font-weight-bold'>Sön:</span> 09:30 - 19:00</h5>
                </li>
              </ul>
